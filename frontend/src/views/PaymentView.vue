...
<template>
  <div
    class="bg-gray-50 min-h-screen pt-24 pb-12 flex flex-col items-center justify-center px-4"
  >
    <div
      class="max-w-lg w-full bg-white rounded-3xl shadow-xl border border-gray-100 p-8 sm:p-10"
    >
      <h2 class="text-3xl font-extrabold text-gray-900 mb-1 text-center">
        {{ payment.title }}
      </h2>
      ...
      <div v-else>
        ...
        <div class="mb-8 p-6 bg-gray-50 rounded-xl border border-gray-100">
          <h3
            class="text-sm font-semibold text-gray-900 mb-4 uppercase tracking-wider"
          >
            Order Summary
          </h3>
        ...
        <div class="mb-8">
          ...
          <div
            id="card-element"
            class="p-4 border border-gray-200 rounded-xl bg-white shadow-sm focus-within:ring-2 focus-within:ring-indigo-500 focus-within:border-indigo-500 transition-all min-h-[50px]"
          >
