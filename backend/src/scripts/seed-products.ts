...
async function main() {
  try {
    ...
    // 檢查賣家是否存在
    const seller = await prisma.user.findUnique({ where: { id: defaultSellerId } });
    if (!seller) {
    ...
    const products = [
      ...
      {
        name: "機械電競鍵盤",
        description: "觸感極佳的機械軸與可自訂 RGB 燈效，打造極致遊戲體驗。耐用鋁合金框架。",
        category: "Gaming",
        price: 129.00,
      ...
      {
        name: "智慧運動手錶",
        description: "精準追蹤您的運動、心率與睡眠。具備防水功能與鮮豔 OLED 螢幕。",
        category: "Wearables",
        price: 199.99,
      ...
      {
        name: "設計師飛行員墨鏡",
        description: "以這款高級飛行員墨鏡展現風格並保護您的雙眼。偏光鏡片減少眩光。",
      ...
      {
        name: "極簡都會後背包",
        description: "適合日常通勤的耐用時尚後背包。具備加厚筆電夾層與防潑水面料。",
        category: "Bags",
        price: 59.90,
